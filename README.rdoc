...
* Reports invalid data import attempts for easy data cleanup (currently not implemented)
  (just use ActiveRecord validations, and after running the script from
  the command line, and the output will give you helpful details about validation errors.)
